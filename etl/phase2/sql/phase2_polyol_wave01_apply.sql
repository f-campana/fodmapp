...
-- Proposal-only draft apply script for polyol_wave01.
...
-- - /Users/fabiencampana/Documents/Fodmap/etl/phase2/data/phase2_polyol_wave01_new_foods.csv (optional for create_new_food rows)
...
SELECT 'polyol_wave01' AS wave_key,
