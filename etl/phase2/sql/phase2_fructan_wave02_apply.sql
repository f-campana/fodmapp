...
-- Proposal-only draft apply script for fructan_wave02.
...
-- - /Users/fabiencampana/Documents/Fodmap/etl/phase2/data/phase2_fructan_wave02_new_foods.csv (optional for create_new_food rows)
...
SELECT 'fructan_wave02' AS wave_key,
