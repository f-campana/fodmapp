...
- Full runs use replay+seed, load deterministic stage contracts into DB snapshot, and collect now-set figures from DB extractors (`collect_reporting.py --source db`).
