...
| `/Users/fabiencampana/Documents/Fodmap-worktrees/ui-state-controls-batch-f`         | `codex/ui-state-controls-batch-f`         | active             | Batch F state controls (`alert-dialog`, `slider`, `switch`, `toggle`, `toggle-group`) | PR #219 open; local and GitHub CI green on 2026-03-13.              |
