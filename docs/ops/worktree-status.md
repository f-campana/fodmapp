...
| `/Users/fabiencampana/Documents/Fodmap-worktrees/mobile-api-p0-mainline`      | `codex/mobile-api-p0-mainline`               | merged (closed)    | Mobile API P0 reintegration            | PR #83 merged to `main`; branch removed remote.    |
| `/Users/fabiencampana/Documents/Fodmap-worktrees/mobile-app-p1-mainline`      | `codex/mobile-app-p1-mainline`               | frozen (source)    | Mobile app P1 source snapshot          | Immutable transplant source for P1 reintegration.  |
| `/Users/fabiencampana/Documents/Fodmap-worktrees/mobile-app-p1-mainline-r2`   | `codex/mobile-app-p1-mainline-r2`            | active (in review) | Mobile app P1 reintegration to `main`  | Scoped PR target branch from latest `origin/main`. |
