...
| `/Users/fabiencampana/Documents/Fodmap-eslint-worktree`                       | `codex/eslint-next-phase`                     | active             | ESLint phase 4 planning + follow-up      | Next-phase planning and architecture testing decisions. |
