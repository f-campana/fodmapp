...
| `/Users/fabiencampana/Documents/Fodmap-eslint-next-phase`                      | `codex/eslint-baseline-next-phase`           | planning           | ESLint baseline follow-up planning       | Phase 2 (Python parity planning + policy scaffolding). |
| `/Users/fabiencampana/Documents/Fodmap-eslint-worktree`                       | `codex/eslint-flat-config`                   | merged             | JS/TS ESLint baseline policy           | PR #73 merged; branch retained only for history review. |
