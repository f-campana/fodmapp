...
| `/Users/fabiencampana/Documents/Fodmap-worktrees/ui-primitives-story-parity`        | `codex/ui-primitives-story-parity`        | active             | Storybook parity pass for badge/card/field/input            | Align primitive stories to Button-level argTypes and play contract. |
