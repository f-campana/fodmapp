...
| `/Users/fabiencampana/Documents/Fodmap-worktrees/mobile-api-p0-mainline`       | `codex/mobile-api-p0-mainline`           | merged (closed)    | Mobile API P0 mainline                     | Merged via PR #83; retained as historical source. |
| `/Users/fabiencampana/Documents/Fodmap-worktrees/mobile-app-p1-mainline-r2`    | `codex/mobile-app-p1-mainline-r2`        | merged (closed)    | Mobile app P1 mainline rerun               | Merged via PR #89; branch/worktree removed.       |
| `/Users/fabiencampana/Documents/Fodmap-worktrees/mobile-app-p1-delta-r3`       | `codex/mobile-app-p1-delta-r3`           | active             | Mobile app P1 post-merge delta triage      | No functional app deltas found vs main so far.    |
| `/Users/fabiencampana/Documents/Fodmap-worktrees/mobile-implementation-track`  | `codex/mobile-implementation-track`      | on-hold            | Mobile implementation track                | Delta source only; do not merge directly.         |
| `/Users/fabiencampana/Documents/Fodmap-worktrees/mobile-research-realignment`  | `codex/mobile-research-realignment`      | active             | Mobile research + ADR decisions            | Research-first stream remains active.             |
