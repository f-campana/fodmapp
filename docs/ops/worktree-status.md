...
| `/Users/fabiencampana/Documents/Fodmap-worktrees/docs-lifecycle-classification`     | `codex/docs-lifecycle-classification`     | merged             | Transition, plans, research, and archive lifecycle classification                    | Merged via PR #197; worktree pending local removal.                 |
