...
| `/Users/fabiencampana/Documents/Fodmap-worktrees/ui-lib-batch-c-dialog-ref`         | `codex/ui-lib-batch-c-dialog-ref`         | active             | PR-07 Batch C dialog reference gate                         | Dialog reference primitive only (gate for PR-08 overlays).          |
