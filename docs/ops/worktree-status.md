...
| `/Users/fabiencampana/Documents/Fodmap-worktrees/public-cutover-decision-record`    | `codex/public-cutover-decision-record`    | active             | PR-1 decision record for public cutover (`ADR-018`)          | Docs-only PR in progress.                                           |
