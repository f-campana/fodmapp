...
| `/Users/fabiencampana/Documents/Fodmap-worktrees/menubar-responsive-a11y`           | `codex/menubar-responsive-a11y`           | active             | Menubar responsive stress a11y remediation exposed by PR #212                        | In progress; intended to unblock build-tooling bump PR #212.        |
