...
| `/Users/fabiencampana/Documents/Fodmap-worktrees/ui-library-fr-market`              | `codex/ui-library-fr-market`              | active             | @fodmap/ui complete shared library rollout (French market)  | PR-01 foundation in progress (React19 migration + hooks/utilities). |
