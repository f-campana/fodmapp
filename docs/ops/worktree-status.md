...
| `/Users/fabiencampana/Documents/Fodmap-worktrees/safe-harbor-v1-rights-gate`        | `codex/safe-harbor-v1-rights-gate`        | merged             | Rights-first evidence gate for Safe-Harbor V1 public/open non-commercial readiness   | Merged via PR #214; local worktree pending cleanup.                 |
| `/Users/fabiencampana/Documents/Fodmap-worktrees/safe-harbor-v1`                    | `codex/safe-harbor-v1`                    | active             | Safe-Harbor V1 schema/API/tests/OpenAPI implementation                               | Rights gate `GO-WITH-CONDITIONS`; CIQUAL + internal rules only.     |
