...
| `/Users/fabiencampana/Documents/Fodmap-worktrees/safe-harbor-v1-rights-gate`        | `codex/safe-harbor-v1-rights-gate`        | active             | Rights-first evidence gate for Safe-Harbor V1 public/open non-commercial readiness   | In progress; Monash runtime reuse path remains blocked by terms.    |
