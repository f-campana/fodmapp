...
| `/Users/fabiencampana/Documents/Fodmap-worktrees/destructive-subtle-token-contract` | `codex/destructive-subtle-token-contract` | active             | Destructive-subtle token contract rollout                   | In progress; local implementation and validation running.           |
