...
| `/Users/fabiencampana/Documents/Fodmap-worktrees/destructive-subtle-token-contract` | `codex/destructive-subtle-token-contract` | active (ready)     | Destructive-subtle token contract rollout                   | PR #134 open, branch pushed, CI green; awaiting merge decision.     |
