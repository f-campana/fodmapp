...
| `/Users/fabiencampana/Documents/Fodmap-worktrees/phase3-composition-zero-batch01`   | `codex/phase3-composition-zero-batch01`   | active             | Phase 3 composition-zero Batch01 research/docs/sql artifacts                         | In progress; dedicated worktree created to restore `main` hygiene.  |
...
| `/Users/fabiencampana/Documents/Fodmap-worktrees/api-workflow-timeout-hardening`    | `codex/api-workflow-timeout-hardening`    | active             | API workflow timeout hardening for runner container-init stalls                      | In progress.                                                        |
