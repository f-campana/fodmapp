...
| `/Users/fabiencampana/Documents/Fodmap-changeset-governance`                  | `codex/changeset-governance-hardening`       | active             | Changeset governance hardening         | Branch-protection-ready PR gate and release changelog polish. |
...
| `/Users/fabiencampana/Documents/Fodmap-eslint-next-phase`                     | `codex/eslint-baseline-next-phase`           | active             | Python parity implementation           | JS/TS baseline merged; Python lint and CI path in progress.   |
