...
| `/Users/fabiencampana/Documents/Fodmap-worktrees/ui-foundation-navigation-batch-l`  | `codex/ui-foundation-navigation-batch-l`  | active             | Batch L foundation navigation and status hardening                                    | Runtime/tests/story migration in progress.                          |
...
| `/Users/fabiencampana/Documents/Fodmap-worktrees/ui-form-composites-batch-g`        | `codex/ui-form-composites-batch-g`        | active             | Batch G form composite hardening                                                      | Calendar, DatePicker, InputOTP, Field, InputGroup.                  |
| `/Users/fabiencampana/Documents/Fodmap-worktrees/safe-harbor-v1-rights-gate`        | `codex/safe-harbor-v1-rights-gate`        | merged             | Rights-first evidence gate for Safe-Harbor V1 public/open non-commercial readiness    | Merged via PR #214; worktree removed.                               |
| `/Users/fabiencampana/Documents/Fodmap-worktrees/safe-harbor-v1`                    | `codex/safe-harbor-v1`                    | merged             | Safe-Harbor V1 schema/API/tests/OpenAPI implementation                                | Merged via PR #216; worktree removed.                               |
...
| `/Users/fabiencampana/Documents/Fodmap-worktrees/ui-state-controls-batch-f`         | `codex/ui-state-controls-batch-f`         | merged             | Batch F state controls (`alert-dialog`, `slider`, `switch`, `toggle`, `toggle-group`) | Merged via PR #219 on 2026-03-13; worktree cleanup pending.         |
...
| `/Users/fabiencampana/Documents/Fodmap-worktrees/safe-harbor-mode-doc`              | `codex/safe-harbor-mode-doc`              | merged             | Product framing note for strict vs guided safe-harbor modes                           | Merged via PR #217; worktree removed.                               |
