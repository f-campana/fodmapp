...
| `/Users/fabiencampana/Documents/Fodmap-worktrees/storybook-structure-next`          | `codex/storybook-structure-next`          | active             | Storybook nested structure contract, `_shared` infra, and recursive taxonomy support | In progress.                                                        |
