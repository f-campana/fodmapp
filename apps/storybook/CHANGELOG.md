...
- [#295](https://github.com/f-campana/fodmapp/pull/295) [`c5ef20c`](https://github.com/f-campana/fodmapp/commit/c5ef20c2a07dcd4c440833266bb819537cfb3709) Thanks [@dependabot](https://github.com/apps/dependabot)! - Bump Storybook tooling dependencies.
...
- [#242](https://github.com/f-campana/fodmapp/pull/242) [`b010bf0`](https://github.com/f-campana/fodmapp/commit/b010bf034720834198b13b26a5d9f89a40b0b44f) Thanks [@f-campana](https://github.com/f-campana)! - Normalize the Storybook component docs surface by migrating legacy flat stories into the canonical nested structure, adding curated docs for lightweight components, and removing the foundations and reporting Storybook sections from the default navigation.
...
- [#235](https://github.com/f-campana/fodmapp/pull/235) [`b485792`](https://github.com/f-campana/fodmapp/commit/b485792bcbbbfdbe6e020bc05160e9587b4d85f9) Thanks [@f-campana](https://github.com/f-campana)! - Add `noindex` hardening (meta + robots.txt) for the public Storybook site.
...
- [#218](https://github.com/f-campana/fodmapp/pull/218) [`163caa2`](https://github.com/f-campana/fodmapp/commit/163caa2fe7dc5be66135845b839557530f9677c2) Thanks [@f-campana](https://github.com/f-campana)! - Establish the nested Storybook story-structure contract, move shared story helpers under `_shared`, and make taxonomy validation resolve mapped story files recursively from the stories root.
