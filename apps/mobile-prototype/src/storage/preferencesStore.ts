...
import { parseOnboardingCompleted, serializeOnboardingCompleted } from './onboarding';

export const PREFERENCES_KEY = '@fodmap/prototype/preferences';
export const ONBOARDING_COMPLETED_KEY = '@fodmap/prototype/onboarding-completed';
...
export async function saveOnboardingCompleted(completed: boolean): Promise<void> {
  await AsyncStorage.setItem(ONBOARDING_COMPLETED_KEY, serializeOnboardingCompleted(completed));
}
